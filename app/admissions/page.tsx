    ...
    <>
      <div className="bg-[#1B3A6B] py-16">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-[#D4AF37] font-sans uppercase text-xs tracking-widest mb-2">Admissions</p>
          <h1 className="text-4xl font-bold text-white mb-3">Admissions Open</h1>
          <p className="text-gray-300 font-sans max-w-xl">
            Join the Tagore family. Admissions are open for the academic year across all five institutions.
          </p>
        </div>
      </div>
